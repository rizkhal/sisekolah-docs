...
Ensure you use [Laravel Valet For Linux](https://github.com/cpriego/valet-linux) or [Laravel Value for MacOS](https://laravel.com/docs/9.x/valet)

> :warning: This app can't running with `artisan serve` because we need domain for separating tenant by the host name
...
Under the `connections` key, unsure you have valid connection to your local database
